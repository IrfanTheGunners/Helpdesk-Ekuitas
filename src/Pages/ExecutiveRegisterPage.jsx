...
const ExecutiveRegisterPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      // Tambahkan user baru dengan role executive
      const newExecutive = {
      ...
      <div className="w-full max-w-md">
        {!success ? (
          <div className="bg-white border border-gray-300 rounded-2xl p-8 shadow-lg">
            ...
            <h2 className="text-3xl font-bold text-center" style={{color: '#5A5858'}}>Register Pimpinan</h2>
            <p className="text-center text-gray-600 mb-8" style={{color: '#5A5858'}}>Buat akun pimpinan untuk akses laporan eksekutif</p>
          ...
          <div className="bg-white border border-gray-300 rounded-2xl p-8 shadow-lg text-center">
            ...
            <p className="text-gray-600 mb-6" style={{color: '#5A5858'}}>Akun pimpinan Anda telah dibuat. Anda akan diarahkan ke halaman login.</p>
...
export default ExecutiveRegisterPage;